...
const RECIPES: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      "250 ml de lait entier (enrichi vit. D)",
      "15 g de graines de chia",
      "5 g de cacao en poudre non sucré",
      "15 g de collagène (peptides)",
      "3 g de créatine monohydrate",
      "120 g de banane (~1 banane)",
      "100 g d'œuf (~2 œufs), à part",
    ],
    steps: [
      "La veille au soir : dans un bocal, mélanger l'avoine, le chia, le lait entier et le cacao. Bien remuer.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Huile d'olive : 17 g (jours saumon) ou 32 g (jours maigres cabillaud/lentilles, pour compenser le gras du poisson)",
  ...
  },
  {
    ...
    steps: [
      ...
      "Concasser grossièrement les amandes et les noix.",
      "Les parsemer sur le yaourt. Aucune cuisson.",
    ],
